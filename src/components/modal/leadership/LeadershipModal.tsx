// components/modal/leadership/LeadershipModal.tsx
import {
  Form,
  FormField,
  FormItem,
...
const LeadershipModal = ({ formMethods, onSubmit, fullClose }: Props) => {
  ...
  return (
    <div>
      ...
      <div className="px-6">
        <h2 className="text-xl font-semibold pt-4">Rahbariyat</h2>
