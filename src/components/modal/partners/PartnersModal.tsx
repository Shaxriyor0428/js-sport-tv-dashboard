...
const PartnersModal = ({ formMethods, fullClose }: Props) => {
  ...
  return (
    <div>
      ...
      <div className="px-6">
        <h2 className="text-xl font-semibold pt-4">Hamkorlar</h2>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Masalan: Hamkor nomi" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <Label>Tavsif</Label>
                  <FormControl>
                    <Input placeholder="Masalan: Izoh" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
